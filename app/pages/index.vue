...
const counts = computed(() => {
  if (!data.value)
    return { locations: 0, buildings: 0, pens: 0, cows: 0, calves: 0, bulls: 0, breedings: 0, notes: 0 }
...
<template>
  <UContainer class="py-10 max-w-5xl">
    <div class="mb-10">
      ...
      <p class="text-gray-500 dark:text-gray-400 mt-1">Vue d'ensemble de votre élevage</p>
    </div>
        ...
        <UCard class="h-full transition-shadow group-hover:shadow-md cursor-pointer">
          <div class="flex items-start justify-between">
            <div>
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Emplacements géographiques</p>
            </div>
          ...
          <div class="mt-4">
            <UBadge color="primary" variant="subtle" size="sm">Gérer →</UBadge>
          </div>
        </UCard>
      </NuxtLink>
      ...
      <UCard class="h-full">
        <div class="flex items-start justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Structures et installations</p>
          </div>
        ...
        <div class="mt-4">
          <UBadge color="neutral" variant="subtle" size="sm">Bientôt</UBadge>
        </div>
      </UCard>
      ...
      <UCard class="h-full">
        <div class="flex items-start justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Espaces d'hébergement</p>
          </div>
      ...
      <UCard class="col-span-1 lg:col-span-2 h-full">
        <div class="flex items-start justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Femelles reproductrices</p>
          </div>
      ...
      <UCard class="h-full">
        <div class="flex items-start justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Mâles reproducteurs</p>
          </div>
      ...
      <UCard class="h-full">
        <div class="flex items-start justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Nouveau-nés du troupeau</p>
          </div>
      ...
      <UCard class="h-full">
        <div class="flex items-start justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Reproductions enregistrées</p>
          </div>
      ...
      <UCard class="h-full">
        <div class="flex items-start justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Observations et remarques</p>
          </div>
